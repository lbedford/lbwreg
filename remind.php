<?php
    ...
    function fakemail($a, $b, $c, $d) {
        // echo "To: $a<br>";
        // echo  "$d<br>";
        // echo  "Subject: $b<br>";
        // echo  nl2br($c)."<br><hr><br>";
        return 0;
    }
    ...
    switch ($status) {
        ...
        //fakemail($email,"Your login details",$message,"From: $teammail");
        break;
        case 2:
        case 3:
        $row = mysql_fetch_array(mysql_query("SELECT logon,email,password FROM people2 WHERE id='$uid'", $db));
        ...
        $message .= "REMOTE_ADDRESS:= $REMOTE_ADDR\r\n";
        ...
        //    fakemail("$teammail","HACK ALERT",$message,"2004@lbwand.org");
        break;
    }
