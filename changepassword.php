...
<form name="passwdForm" method="post" onSubmit="return validatePwd()" action="<?php echo $regpath;?>/change.php">
    Old Password: <input type="password" name="old_password" size="40" /><br />
    New Password: <input type="password" name="password" size="40" /><br />
    Verify Password:<input type="password" name="verify" size="40" /><br />
