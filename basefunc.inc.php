<?php # -*- php -*-
    ...
    function HtmlHead($page, $title, $status, $userid, $javascript = '') {
        ...
        echo "<!-- Piwik --><script type=\"text/javascript\">var _paq = _paq || [];_paq.push(['trackPageView']);_paq.push(['enableLinkTracking']);(function() {var u=((\"https:\" == document.location.protocol) ? \"https\" : \"http\") + \"://lbwreg.draiocht.net/analytics//\";_paq.push(['setTrackerUrl', u+'piwik.php']);_paq.push(['setSiteId', 1]);var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0]; g.type='text/javascript';g.defer=true; g.async=true; g.src=u+'piwik.js'; s.parentNode.insertBefore(g,s);})();</script><noscript><p><img src=\"http://lbwreg.draiocht.net/analytics/piwik.php?idsite=1\" style=\"border:0\" alt=\"\" /></p></noscript><!-- End Piwik Code -->";
        echo "</head>\n";
