<?php
    ...
    $query="SELECT  people2.id as id, firstname, surname, email,city,country.name as country, arrival, departure, attending, children,kindofaccomodation,present FROM people2,country  where (attending>0) AND (country.id = people2.country)  AND (status>1)  ORDER by $order $ordering";
